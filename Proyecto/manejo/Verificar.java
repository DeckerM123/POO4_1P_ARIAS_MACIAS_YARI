...
public abstract class Verificar {
    ...
    public static Usuario iniciarSesion() {
        ...
        try {
            String[] usuarios = Persistencia.leerArchivo(Archivo.USUARIOS).split("\n");
            for (int i = 0; i < usuarios.length; i++) {
                ...
                if (usuario.equals(username) && contrasena.equals(password)) {
                    switch (tipo) {
                        case "E":
                            String editorBuscado = Persistencia.busquedaEnArchivo(Archivo.EDITORES, codigo);
                            ...
                            break;
                        case "R":
                            String revisorBuscado = Persistencia.busquedaEnArchivo(Archivo.REVISORES, codigo);
