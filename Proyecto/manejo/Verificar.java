...
public abstract class Verificar {
    ...
    public static Usuario iniciarSesion() {
        ...
        try {
            String[] usuarios = ManejoDatos.leerArchivo(Archivo.USUARIOS).split("\n");
            for (int i = 0; i < usuarios.length; i++) {
                ...
                if (usuario.equals(username) && contrasena.equals(password)) {
                    switch (tipo) {
                        case "E":
                            String editorBuscado = ManejoDatos.busquedaEnArchivo(Archivo.EDITORES, codigo);
                            ...
                            break;
                        case "R":
                            String revisorBuscado = ManejoDatos.busquedaEnArchivo(Archivo.REVISORES, codigo);
