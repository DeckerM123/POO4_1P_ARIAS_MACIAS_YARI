...
public class ManejoDatos {
     ...
     * @throws IOException Si ocurre un error al leer el archivo
     */
    public static String buscarArchivo(String nombreArchivo, String busqueda) throws IOException {
        try (BufferedReader br = new BufferedReader(new FileReader(nombreArchivo))) {
            String linea;
            while ((linea = br.readLine()) != null) {
     ...
     */
    public static void modificarArchivo(String nombreArchivo, String lineaVieja, String lineaNueva) throws IOException {
