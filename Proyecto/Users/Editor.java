...
public class Editor extends Usuario {
     ...
     */
    protected boolean crearCorreo(String destinatario, String asunto, String mensaje) {
        ...
        try {
            ...
            for (int i = 0; i < revisionesViejas.size(); i++) {
                ...
                try {
                    ...
                    if (!estadoRevision.equals(EstadoRevision.PENDIENTE)) {
                        ...
                        ManejoDatos.modificarArchivo(Archivo.REVISIONES, revisionVieja,
            ...
            for (int i = 0; i < autores.length; i++) {
                ...
                if (datosAutor[0].equals(articulo.getAutor())) {
                    ...
                    boolean enviado = crearCorreo(datosAutor[3], "Decisión sobre Art#" + articulo.getCodigo(),
                            mensaje);
                    if (enviado) {
