...
public class Revisor extends Usuario {
     ...
     */
    public boolean crearCorreo(String destinatario, String asunto, String mensaje) {
     ...
     */
    public void decisionDeArticulo(Articulo articulo) {
        ...
        try {
            String revisorVieja = ManejoDatos.buscarArchivo(Archivo.REVISORES, codigo);
            String[] revisorNueva = revisorVieja.split(",");
            revisorNueva[5] = String.valueOf(Integer.parseInt(revisorNueva[5]) + 1);
            ManejoDatos.modificarArchivo(Archivo.REVISORES, revisorVieja,","+revisorNueva);

            String revisionVieja = ManejoDatos.buscarArchivo(Archivo.REVISIONES,
                    codigo + ";" + articulo.getCodigo());
            ManejoDatos.modificarArchivo(Archivo.REVISIONES, revisionVieja, registro);
